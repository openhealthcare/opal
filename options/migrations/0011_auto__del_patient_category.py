...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'Patient_category'
        db.delete_table(u'options_patient_category')


    def backwards(self, orm):
        # Adding model 'Patient_category'
        db.create_table(u'options_patient_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
        ))
        db.send_create_signal(u'options', ['Patient_category'])
