...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Synonym', fields ['name']
        db.delete_unique(u'options_synonym', ['name'])

        # Adding unique constraint on 'Synonym', fields ['name', 'content_type']
        db.create_unique(u'options_synonym', ['name', 'content_type_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Synonym', fields ['name', 'content_type']
        db.delete_unique(u'options_synonym', ['name', 'content_type_id'])

        # Adding unique constraint on 'Synonym', fields ['name']
        db.create_unique(u'options_synonym', ['name'])
