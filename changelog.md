...
This is a list of functions attatched to the episode.

When an extract is done these will be called with the
episode iterable generated by the query, the directory these which
will be zipped and returned to the user and the user who made the
query.
