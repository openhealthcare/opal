...
A list attached to the application object of functions or of string paths to functions.

When an extract is done these will be called with the
episode iterable generated by the query, the directory that will be zipped and the user who made the query.
