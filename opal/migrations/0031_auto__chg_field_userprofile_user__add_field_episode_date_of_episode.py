...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'opal_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
        # Adding field 'Episode.date_of_episode'
        db.add_column(u'opal_episode', 'date_of_episode',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'UserProfile.user'
        db.alter_column(u'opal_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
        # Deleting field 'Episode.date_of_episode'
        db.delete_column(u'opal_episode', 'date_of_episode')
