...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.restricted_only'
        db.add_column(u'opal_userprofile', 'restricted_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.restricted_only'
        db.delete_column(u'opal_userprofile', 'restricted_only')
