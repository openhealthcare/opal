...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'opal_episode', 'category',
                      self.gf('django.db.models.fields.CharField')(default='inpatient', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.category'
        db.delete_column(u'opal_episode', 'category')
