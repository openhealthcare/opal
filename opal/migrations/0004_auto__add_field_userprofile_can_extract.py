...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.can_extract'
        db.add_column(u'opal_userprofile', 'can_extract',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.can_extract'
        db.delete_column(u'opal_userprofile', 'can_extract')
