...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tagging.episode'
        db.alter_column(u'opal_tagging', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['opal.Episode']))

    def backwards(self, orm):

        # Changing field 'Tagging.episode'
        db.alter_column(u'opal_tagging', 'episode_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Episode'], null=True))
