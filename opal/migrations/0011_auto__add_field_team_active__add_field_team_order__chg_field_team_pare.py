...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'opal_team', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Team.order'
        db.add_column(u'opal_team', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Team.parent'
        db.alter_column(u'opal_team', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['opal.Team'], null=True))
        # Deleting field 'Tagging.tag_name'
        db.delete_column(u'opal_tagging', 'tag_name')


    def backwards(self, orm):
        # Deleting field 'Team.active'
        db.delete_column(u'opal_team', 'active')

        # Deleting field 'Team.order'
        db.delete_column(u'opal_team', 'order')


        # User chose to not deal with backwards NULL issues for 'Team.parent'
        raise RuntimeError("Cannot reverse this migration. 'Team.parent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Tagging.tag_name'
        raise RuntimeError("Cannot reverse this migration. 'Tagging.tag_name' and its values cannot be restored.")
