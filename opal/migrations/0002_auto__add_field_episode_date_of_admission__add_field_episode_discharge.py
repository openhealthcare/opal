...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Episode.date_of_admission'
        db.add_column(u'opal_episode', 'date_of_admission',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Episode.discharge_date'
        db.add_column(u'opal_episode', 'discharge_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Episode.date_of_admission'
        db.delete_column(u'opal_episode', 'date_of_admission')

        # Deleting field 'Episode.discharge_date'
        db.delete_column(u'opal_episode', 'discharge_date')
