...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Drug'
        db.create_table(u'opal_drug', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'opal', ['Drug'])

        # Adding model 'Drugroute'
        db.create_table(u'opal_drugroute', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'opal', ['Drugroute'])

        # Adding model 'Drugfreq'
        db.create_table(u'opal_drugfreq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'opal', ['Drugfreq'])


    def backwards(self, orm):
        # Deleting model 'Drug'
        db.delete_table(u'opal_drug')

        # Deleting model 'Drugroute'
        db.delete_table(u'opal_drugroute')

        # Deleting model 'Drugfreq'
        db.delete_table(u'opal_drugfreq')
