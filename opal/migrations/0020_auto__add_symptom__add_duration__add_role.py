...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'opal', ['Role'])

        # Adding M2M table for field roles on 'UserProfile'
        m2m_table_name = db.shorten_name(u'opal_userprofile_roles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'opal.userprofile'], null=False)),
            ('role', models.ForeignKey(orm[u'opal.role'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'opal_userprofile_roles'))
