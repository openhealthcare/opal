...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Gender'
        db.create_table(u'opal_gender', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'opal', ['Gender'])

        # Adding model 'Ethnicity'
        db.create_table(u'opal_ethnicity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'opal', ['Ethnicity'])


    def backwards(self, orm):
        # Deleting model 'Gender'
        db.delete_table(u'opal_gender')

        # Deleting model 'Ethnicity'
        db.delete_table(u'opal_ethnicity')
