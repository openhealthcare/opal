...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Microbiology_reason_not_done'
        db.create_table(u'opal_microbiology_reason_not_done', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'opal', ['Microbiology_reason_not_done'])


    def backwards(self, orm):
        # Deleting model 'Microbiology_reason_not_done'
        db.delete_table(u'opal_microbiology_reason_not_done')
    ...
    models = {
        ...
        u'opal.microbiology_reason_not_done': {
            'Meta': {'ordering': "['name']", 'object_name': 'Microbiology_reason_not_done'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        u'opal.patient': {
