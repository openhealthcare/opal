...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactNumber'
        db.create_table(u'opal_contactnumber', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'opal', ['ContactNumber'])

        # Adding M2M table for field useful_numbers on 'Team'
        m2m_table_name = db.shorten_name(u'opal_team_useful_numbers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm[u'opal.team'], null=False)),
            ('contactnumber', models.ForeignKey(orm[u'opal.contactnumber'], null=False))
        ))
        db.create_unique(m2m_table_name, ['team_id', 'contactnumber_id'])


    def backwards(self, orm):
        # Deleting model 'ContactNumber'
        db.delete_table(u'opal_contactnumber')

        # Removing M2M table for field useful_numbers on 'Team'
        db.delete_table(db.shorten_name(u'opal_team_useful_numbers'))
    ...
    models = {
        ...
        u'opal.team': {
            ...
            'useful_numbers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['opal.ContactNumber']", 'symmetrical': 'False'})
        },
