...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'opal', ['Reported_infections'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Reported_infections'
        db.delete_table(u'opal_reported_infections')
    ...
    models = {
        ...
        u'opal.reported_infections': {
            'Meta': {'ordering': "['name']", 'object_name': 'Reported_infections'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        u'opal.synonym': {
