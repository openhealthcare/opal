    ...
    def list(self, request):
        ...
        if request.user.is_authenticated():
            ...
            for team in teams:
                ...
                if team.visibile_in_list:
                    tag_visibile_in_list.append(team.name)
                ...
                for sub in subteams:
                    ...
                    if sub.visibile_in_list:
                        tag_visibile_in_list.append(sub.name)

        data['tag_hierarchy'] = tag_hierarchy
        data['tag_display'] = tag_display
        data['tag_visibile_in_list'] = tag_visibile_in_list
