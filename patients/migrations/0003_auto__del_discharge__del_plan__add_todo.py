...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ToDo'
        db.create_table(u'patients_todo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('details', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('patient', self.gf('django.db.models.fields.related.OneToOneField')(related_name='to_do', unique=True, to=orm['patients.Patient'])),
        ))
        db.send_create_signal(u'patients', ['ToDo'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ToDo'
        db.delete_table(u'patients_todo')
    ...
    models = {
        ...
        u'patients.todo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'to_do'", 'unique': 'True', 'to': u"orm['patients.Patient']"})
        },
        u'patients.travel': {
