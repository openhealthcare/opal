...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Diagnosis.date_of_diagnosis'
        db.add_column(u'patients_diagnosis', 'date_of_diagnosis',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Diagnosis.date_of_diagnosis'
        db.delete_column(u'patients_diagnosis', 'date_of_diagnosis')
