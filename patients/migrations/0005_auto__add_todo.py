...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'patients_todo', (
            ...
            ('patient', self.gf('django.db.models.fields.related.OneToOneField')(related_name='todo', unique=True, to=orm['patients.Patient'])),
        ))
    ...
    models = {
        ...
        u'patients.todo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'todo'", 'unique': 'True', 'to': u"orm['patients.Patient']"})
        },
        u'patients.travel': {
