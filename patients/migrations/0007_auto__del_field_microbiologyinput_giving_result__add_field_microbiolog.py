...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Todo', fields ['patient']
        db.delete_unique(u'patients_todo', ['patient_id'])

        # Deleting field 'MicrobiologyInput.giving_result'
        db.delete_column(u'patients_microbiologyinput', 'giving_result')

        # Adding field 'MicrobiologyInput.referred_to_opat'
        db.add_column(u'patients_microbiologyinput', 'referred_to_opat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MicrobiologyInput.reason_for_interaction_fk'
        db.add_column(u'patients_microbiologyinput', 'reason_for_interaction_fk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['options.Clinical_advice_reason_for_interaction'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'MicrobiologyInput.reason_for_interaction_ft'
        db.add_column(u'patients_microbiologyinput', 'reason_for_interaction_ft',
    ...
    def backwards(self, orm):
        # Adding field 'MicrobiologyInput.giving_result'
        db.add_column(u'patients_microbiologyinput', 'giving_result',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'MicrobiologyInput.referred_to_opat'
        db.delete_column(u'patients_microbiologyinput', 'referred_to_opat')

        # Deleting field 'MicrobiologyInput.reason_for_interaction_fk'
        db.delete_column(u'patients_microbiologyinput', 'reason_for_interaction_fk_id')

        # Deleting field 'MicrobiologyInput.reason_for_interaction_ft'
        db.delete_column(u'patients_microbiologyinput', 'reason_for_interaction_ft')


        # Changing field 'Todo.patient'
        db.alter_column(u'patients_todo', 'patient_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['patients.Patient']))
        # Adding unique constraint on 'Todo', fields ['patient']
        db.create_unique(u'patients_todo', ['patient_id'])
    ...
    models = {
        ...
        u'patients.todo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'todo'", 'to': u"orm['patients.Patient']"})
        },
        u'patients.travel': {
