...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Location', fields ['patient']
        db.delete_unique(u'patients_location', ['patient_id'])

        # Removing unique constraint on 'Demographics', fields ['patient']
        db.delete_unique(u'patients_demographics', ['patient_id'])

        # Adding field 'Antimicrobial.consistency_token'
        db.add_column(u'patients_antimicrobial', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)

        # Adding field 'Travel.consistency_token'
        db.add_column(u'patients_travel', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)

        # Adding field 'GeneralNote.consistency_token'
        db.add_column(u'patients_generalnote', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)

        # Adding field 'PastMedicalHistory.consistency_token'
        db.add_column(u'patients_pastmedicalhistory', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)

        # Adding field 'Diagnosis.consistency_token'
        db.add_column(u'patients_diagnosis', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)

        # Adding field 'MicrobiologyInput.consistency_token'
        db.add_column(u'patients_microbiologyinput', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)

        # Adding field 'Demographics.consistency_token'
        db.add_column(u'patients_demographics', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)


        # Changing field 'Demographics.patient'
        db.alter_column(u'patients_demographics', 'patient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patients.Patient']))
        # Adding field 'MicrobiologyTest.consistency_token'
        db.add_column(u'patients_microbiologytest', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)

        # Adding field 'Todo.consistency_token'
        db.add_column(u'patients_todo', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)

        # Adding field 'Location.consistency_token'
        db.add_column(u'patients_location', 'consistency_token',
                      self.gf('django.db.models.fields.CharField')(default='12345678', max_length=8),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Antimicrobial.consistency_token'
        db.delete_column(u'patients_antimicrobial', 'consistency_token')

        # Deleting field 'Travel.consistency_token'
        db.delete_column(u'patients_travel', 'consistency_token')

        # Deleting field 'GeneralNote.consistency_token'
        db.delete_column(u'patients_generalnote', 'consistency_token')

        # Deleting field 'PastMedicalHistory.consistency_token'
        db.delete_column(u'patients_pastmedicalhistory', 'consistency_token')

        # Deleting field 'Diagnosis.consistency_token'
        db.delete_column(u'patients_diagnosis', 'consistency_token')

        # Deleting field 'MicrobiologyInput.consistency_token'
        db.delete_column(u'patients_microbiologyinput', 'consistency_token')

        # Deleting field 'Demographics.consistency_token'
        db.delete_column(u'patients_demographics', 'consistency_token')


        # Changing field 'Demographics.patient'
        db.alter_column(u'patients_demographics', 'patient_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['patients.Patient']))
        # Adding unique constraint on 'Demographics', fields ['patient']
        db.create_unique(u'patients_demographics', ['patient_id'])

        # Deleting field 'MicrobiologyTest.consistency_token'
        db.delete_column(u'patients_microbiologytest', 'consistency_token')

        # Deleting field 'Todo.consistency_token'
        db.delete_column(u'patients_todo', 'consistency_token')

        # Deleting field 'Location.consistency_token'
        db.delete_column(u'patients_location', 'consistency_token')


        # Changing field 'Location.patient'
        db.alter_column(u'patients_location', 'patient_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['patients.Patient']))
        # Adding unique constraint on 'Location', fields ['patient']
        db.create_unique(u'patients_location', ['patient_id'])
